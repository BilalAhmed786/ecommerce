            ...
            <h3 style={{textAlign:'center',marginBottom:35}}>{data?data.productname:""}</h3>
                ...
                <div className='imggallery'>
                    ...
                    <div className='productimg'>
                        ...
                        <img className='singlepro-img' src={`http://localhost:3001/uploads/${data.galleryimages[currentImageIndex]}`} alt='' />
                    ...
                    {data ? data.galleryimages.map((gallery, index) => (
                        ...
                        <div className='gallery'>
                            <img className='singlepro-gallery' src={`http://localhost/3001/uploads/${gallery}`} alt='' />
                        </div>
